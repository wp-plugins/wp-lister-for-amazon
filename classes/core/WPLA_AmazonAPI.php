...
class WPLA_AmazonAPI {
	...
	public function __construct( $account_id = false ) {
        ...
        if ( $account_id ) {
            ...
            // echo "<pre>";print_r($this->account);echo"</pre>";die();

            $this->account_id = $account_id;
            $this->market_id  = $this->account->market_id;
            // $this->api_url    = str_replace( 'amazon', 'https://mws.amazonservices', $this->account->getMarket()->url );
        ...
        // $this->serverScript  = 'https://mws.amazonservices.de/Orders/2011-01-01';
        // $this->serverScript .= '?AWSAccessKeyId='.$AWSAccessKeyId;
