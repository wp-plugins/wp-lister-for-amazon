...
<div class="wrap">
	...
	<form method="post" action="<?php echo $wpl_form_action; ?>">
		<div class="submit" style="padding-top: 0; float: left; padding-left:0;">
			...
			<?php else : ?>
				<input type="hidden" name="action" value="resubmit_all_failed" />
	...
	<script type="text/javascript">
		jQuery( document ).ready( function () {
			...
			jQuery(".tablenav .actions input[type='submit'].action").on('click', function() {
				...
				if ( selected_action == 'fetch_pdescription' ) {
				...
				if ( selected_action == 'trash_listing' ) {
				...
				if ( item_ids.length > 0 ) {
					...
					if ( 'fetch_pdescription' == selected_action ) {
