...
<body class="wp-core-ui">
    ...
    <div class="tab-content wpla_tab_feed_content_wrapper">
        ...
        <h2 style="margin-top:0;">Amazon Feed <?php echo $wpl_feed->FeedSubmissionId ?> <!--(<?php echo $wpl_feed->id ?>)--></h2>
        ...
        <table>
            ...
            <tr><td>
                ...
                ( <?php echo human_time_diff( strtotime($wpl_feed->SubmittedDate) ) ?> ago )
            </td></tr>
            <?php endif; ?>
        </table>
        <br>
        ...
        <!-- <h3>Debug Data</h3> -->
        <br>
        <pre id="wpla_feed_details_debug" style="display:none"><?php print_r( $wpl_feed ) ?></pre>
        ...
        <a href="admin.php?page=wpla-feeds&amp;action=view_amazon_feed_details_raw&amp;amazon_feed=<?php echo $wpl_feed->id ?>" class="button" target="_blank">View raw feed</a> &nbsp;
        <a href="admin.php?page=wpla-feeds&amp;action=wpla_download_feed_content&amp;amazon_feed=<?php echo $wpl_feed->id ?>" class="button">Download CSV</a>
    ...
    <div class="tab-content wpla_tab_feed_results_wrapper" style="display:none;">
        ...
        <p>
            <a href="admin.php?page=wpla-feeds&amp;action=wpla_download_feed_results&amp;amazon_feed=<?php echo $wpl_feed->id ?>" class="button">Download CSV</a>
        </p>
