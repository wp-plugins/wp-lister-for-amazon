...
<body>
    ...
    <table class="wpla_match_results" style="width:100%; margin-top:2em;">
        ...
        <tr><td class="info hover">
            ...
            <!-- Regular Price: <?php echo woocommerce_price( $wpl_product->get_regular_price() ) ?><br> -->
            <!-- Sale Price: <?php echo woocommerce_price( $wpl_product->get_sale_price() ) ?><br> -->

        </td><td class="info hover" style="text-align:right; width:20%;">

            <?php if ( $wpl_product->get_sale_price() ) : ?>
                <big><del><?php echo woocommerce_price( $wpl_product->get_regular_price() ) ?></del></big> 
                <big><?php echo woocommerce_price( $wpl_product->get_sale_price() ) ?></big> 
                <br>
            <?php else : ?>
                <big><?php echo woocommerce_price( $wpl_product->get_regular_price() ) ?></big>
                <br>
            <?php endif; ?>
        ...
        <tr><td colspan="2">
            ...
            <br>
            Your min. price: <?php echo woocommerce_price( $wpl_listing['min_price'] ) ?><br>
            Your max. price: <?php echo woocommerce_price( $wpl_listing['max_price'] ) ?><br>
