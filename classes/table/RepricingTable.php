...
class WPLA_RepricingTable extends WPLA_ListingsTable {
    ...
    function get_edit_price_field( $col, $price, $item ){
        ...
        $form_field .= 'value="'.number_format($price,2).'" ';
    ...
    function get_views(){
        ...
        $all_url = remove_query_arg( 'repricing_status', $base_url );
    ...
    function extra_tablenav( $which ) {
        ...
        $btn_url  = add_query_arg( 'action', 'wpla_apply_lowest_price_to_all_items', $base_url );
        ?>
        <div class="alignleft actions" style="">

            <a href="<?php echo $btn_url ?>" class="button"><?php echo __('Apply lowest price to all items','wpla') ?></a>

            <a href="#" id="btn_toggle_price_editor" class="button"><?php echo __('Edit Prices','wpla') ?></a>
