...
<body>
    ...
    <!-- <h3>Matching products for <i><?php #echo $wpl_query ?></i> -->
        ...
        <form id="wpla_matcher_query_form" action="#">
            ...
            <input type="text"   name="query"  value="<?php echo $wpl_query ?>" id="wpla_matcher_query_input" />
            <!-- <input type="text"   name="query"  value="<?php echo $wpl_query ?>" id="wpla_matcher_query_select" /> -->
