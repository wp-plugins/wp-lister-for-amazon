							...
							<div id="wrap_account_details" style="display:none">
								...
								<p style="padding-left:0.2em;">
									...
									<ol>
										...
										<li>Select "I want to access my own Amazon seller account with MWS."</li>
										<li>Accept the Amazon MWS License Agreement.</li>
										<li>Copy the generated Merchant ID, Marketplace ID, AWS Access Key ID, and Secret Key and paste it in the corresponding fields below.</li>
								...
								<label for="wpla_merchant_id" class="text_label"><?php echo __('Merchant ID','wpla'); ?>:</label>
								...
								<input type="text" name="wpla_marketplace_id" id="wpla_marketplace_id" value="<?php echo @$wpla_marketplace_id ?>" class="text_input" />
