			...
			<div id="postbox-container-1" class="postbox-container">
				<div id="side-sortables" class="meta-box">
					...
					<div class="postbox" id="ProfilesBox">
						<h3><span><?php echo __('Profile','wpla'); ?></span></h3>
						<div class="inside">
					...
					<div class="postbox" id="HelpBox">
						<h3><span><?php echo __('Information','wpla'); ?></span></h3>
						<div class="inside">
							<p>
			...
			<div id="postbox-container-2" class="postbox-container">
				<div class="meta-box-sortables ui-sortable">
					...
					<div class="postbox" id="GeneralSettingsBox">
						<h3><span><?php echo __('Item settings','wpla'); ?></span></h3>
						<div class="inside">
					...
					<div class="postbox" id="DeveloperToolBox" style="display:x-none;">
						<h3><span><?php echo __('Developer options','wpla'); ?></span></h3>
						<div class="inside">
							<p>
