...
class WPLA_ReportsTable extends WP_List_Table {
    ...
    function column_details($item){
        ...
        $actions = array(
            ...
            'load_report_from_amazon'    => sprintf('<a href="?page=%s&action=%s&amazon_report=%s">%s</a>',$_REQUEST['page'],'load_report_from_amazon',$item['id'],__('Load','wpla')),
            'process_amazon_report'      => sprintf('<a href="?page=%s&mode=%s&report_id=%s&step=2">%s</a>','wpla-import','inventory',$item['id'],__('Process Report','wpla')),
            'process_fba_report'         => sprintf('<a href="?page=%s&action=%s&amazon_report=%s" data-id="%s">%s</a>',$_REQUEST['page'],'process_amazon_report',$item['id'],$item['id'],__('Process FBA Report','wpla')),
            'process_fba_shipment_report' => sprintf('<a href="?page=%s&action=%s&amazon_report=%s" data-id="%s">%s</a>',$_REQUEST['page'],'process_fba_shipment_report',$item['id'],$item['id'],__('Process Report','wpla')),
            'process_quality_report'     => sprintf('<a href="?page=%s&action=%s&amazon_report=%s" data-id="%s">%s</a>',$_REQUEST['page'],'process_amazon_report',$item['id'],$item['id'],__('Process Quality Report','wpla')),
    ...
    function column_account_id($item){
        ...
        return WPLA_AmazonAccount::getAccount( $account_id )->title;
