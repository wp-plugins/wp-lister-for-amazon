...
WPLA.ProfileSelector = function () {
    ...
    var select = function ( obj, profile_id ) {
        ...
        .success( function( response ) { 
            ...
            if ( response.success ) {
                ...
                // var column_html = '<a href="'+response.url+'" title="View on Amazon" target="_blank"><img src="'+wpla_ProfileSelector_i18n.WPLA_URL+'/img/amazon-16x16.png" alt="yes" /></a>';
                // jQuery('tr#post-'+profile_id+' .column-listed_on_amazon').html( column_html );
    ...
    var showWindow = function ( title ) {
        ...
        var tbURL = ajaxurl + "?action=wpla_show_profile_selection&width=640&height=420"; 
