			...
			<div id="postbox-container-1" class="postbox-container">
				<div id="side-sortables" class="meta-box">
					...
					<div class="postbox" id="TemplateVersionsBox">
						<h3><span><?php echo __('Installed Feed Templates','wpla'); ?></span></h3>
						<div class="inside">
							...
							<?php foreach ( $wpl_installed_templates as $template ) : ?>
								<?php 
									...
									$remove_link   = 'admin.php?page=wpla-settings&tab=categories&action=wpla_remove_tpl&tpl_id='.$template->id;
								?>
