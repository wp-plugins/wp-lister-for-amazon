...
class WPLA_AccountsTable extends WP_List_Table {
    ...
    function column_details($item){
        ...
        $actions = array(
            ...
            'update_account'  => sprintf('<a href="?page=%s&tab=accounts&action=%s&amazon_account=%s">%s</a>',$_REQUEST['page'],'update_account',$item['id'],__('Update','wpla')),
            'enable_account'  => sprintf('<a href="?page=%s&tab=accounts&action=%s&amazon_account=%s">%s</a>',$_REQUEST['page'],'enable_account',$item['id'],__('Enable','wpla')),
            'disable_account' => sprintf('<a href="?page=%s&tab=accounts&action=%s&amazon_account=%s">%s</a>',$_REQUEST['page'],'disable_account',$item['id'],__('Disable','wpla')),
            'make_default'    => sprintf('<a href="?page=%s&tab=accounts&action=%s&amazon_account=%s">%s</a>',$_REQUEST['page'],'make_default',$item['id'],__('Make default','wpla')),
            'delete_account'  => sprintf('<a href="?page=%s&tab=accounts&action=%s&amazon_account=%s">%s</a>',$_REQUEST['page'],'delete_account',$item['id'],__('Delete','wpla')),
